...
#     data.order_no = invoice.order.order_no if invoice.order else None
#     return data
...
# ):
#     items, total = service.list(db, order_id, status, page, page_size)
...
#     invoice = service.repo.get_by_order_id(db, order.id)
#     if not invoice:
#         from app.invoices.error_codes import InvoiceErrorCode
#         from app.core.exceptions import AppException
#         raise AppException(404, InvoiceErrorCode.INVOICE_NOT_FOUND, "No invoice found for this order")
#     return _to_response(invoice)
