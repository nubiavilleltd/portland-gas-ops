...
from app.utils.cloudinary import upload_image, upload_document
from app.services.email_service import send_account_setup
...
def update_profile_picture(employee_id: str, user_id: str, file: UploadFile, db: Session) -> Employee:
    ...
    url = upload_image(file_bytes, public_id=f"profile_{user_id}")
...
def upload_employee_document(
    ...
    url = upload_document(file_bytes, public_id)
