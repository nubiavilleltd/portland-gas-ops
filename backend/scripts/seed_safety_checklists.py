...
TEMPLATES: tuple[ChecklistTemplateSeed, ...] = (
    ...
    ChecklistTemplateSeed(
        ...
        code="INCIDENT_REPORT_RISK_ASSESSMENT",
        name="Incident Report Impact Checks",
        parent_type=SafetyChecklistParentType.incident_report,
        stage=SafetyChecklistStage.risk_assessment,
        description="Initial impact checks completed by the incident or hazard reporter.",
        items=(
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222801",
            ...
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222802",
            ...
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222803",
    ...
    ChecklistTemplateSeed(
        ...
        code="WA_HSE_INSPECTION",
        name="Work Authorization HSE Inspection",
        parent_type=SafetyChecklistParentType.work_authorization,
        stage=SafetyChecklistStage.inspection,
        description="HSE inspection checks completed before work authorization approval.",
        items=(
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222601",
            ...
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222602",
            ...
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222603",
            ...
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222604",
                item_key="ppe_and_safety_kits_available",
                label="PPE and safety kits available",
                input_type=SafetyChecklistInputType.enum,
                options_json=[
                    {"value": "pass", "label": "Pass"},
                    {"value": "fail", "label": "Fail"},
            ...
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222605",
                item_key="safety_controls_in_place",
                label="Safety controls in place",
                input_type=SafetyChecklistInputType.enum,
                options_json=[
                    {"value": "pass", "label": "Pass"},
                    {"value": "fail", "label": "Fail"},
            ...
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222606",
                item_key="hse_inspection_result",
            ...
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222607",
    ...
    ChecklistTemplateSeed(
        ...
        items=(
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222701",
            ...
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222702",
            ...
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222703",
            ...
            ChecklistItemSeed(
                id="22222222-2222-2222-2222-222222222704",
                item_key="root_cause",
