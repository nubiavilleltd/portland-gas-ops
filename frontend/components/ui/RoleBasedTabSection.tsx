...
export default function RoleBasedTabSection<T extends string>({
  id,
  currentRole,
  onRoleChange,
  roleLabel,
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <h2
              className={
                recordLabel
                  ? "mt-1 text-xl font-semibold text-brand-text-primary"
                  : "text-xl font-semibold text-brand-text-primary"
              }
            >
            ...
            {nextApproverRole ? (
              ...
              <p className="mt-1 text-sm text-brand-text-secondary">
                Next Actor:{" "}
                <span className="font-medium text-brand-text-primary">
                  {nextActor.toLowerCase() === "closed" ? "None" : nextActor}
                </span>
              </p>
            ) : null}
          </div>
