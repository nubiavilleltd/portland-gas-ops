...
//       <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4 mb-6">
//         <KpiCard2 label="Total Orders" value={kpis.totalOrders}/>
//         <KpiCard2 label="Pending Dispatch" value={kpis.pendingDispatch} />
//         <KpiCard2 label="In Transit" value={kpis.inTransit} />
//         <KpiCard2 label="Delivered" value={kpis.delivered} />
//         <KpiCard2
//           label="Total Revenue"
//           value={formatCurrency(kpis.totalRevenue)}
//         />
