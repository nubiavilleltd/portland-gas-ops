...
const INITIAL_EVENTS: IntranetEvent[] = [
  ...
  { id: 2, title: "HSE Field Safety Refresher — Lagos Stations", description: "", event_type: "Training",  location: `${COMPANY_NAME} Training Centre`, virtual_link: "", event_date: "2026-06-18", color: "#166534", is_published: true, created_at: NOW, updated_at: NOW },
