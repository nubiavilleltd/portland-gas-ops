            ...
            <div className="space-y-5">
              ...
              <div className="bg-white border border-brand-border rounded-2xl p-5">
                ...
                <div className="flex flex-col items-center gap-3">
                  ...
                  <button onClick={downloadQR} className="w-full flex items-center justify-center gap-2 px-4 py-2 border border-brand-border text-brand-text-primary text-sm font-medium rounded-lg hover:bg-gray-50 transition-colors">
