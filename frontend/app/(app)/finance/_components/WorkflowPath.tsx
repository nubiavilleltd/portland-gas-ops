...
export default function WorkflowPath({ initiator, department, currentStep }: Props) {
              ...
              >
                <p
                  className={cn(
                    ...
                    isActive ? "text-purple-200" : "text-brand-purple"
                  )}
                >
                  {step.role}
                </p>
                <p
                  className={cn(
                    ...
                    isActive ? "text-white" : "text-brand-text-primary"
                  )}
                >
                  {step.name}
                </p>
                <p
                  className={cn(
                    "text-xs mt-0.5",
                    isActive ? "text-purple-200" : "text-brand-text-secondary"
                  )}
                >
                  {step.title}
                </p>
