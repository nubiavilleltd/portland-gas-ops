...
import { ArrowLeft, Banknote, User, Building2, Calendar, Tag, Hash, AlignLeft } from "lucide-react";
import AppLayout from "@/components/layout/AppLayout";
import ApprovalBadge from "@/components/ui/ApprovalBadge";
import { formatCurrency, formatDate } from "@/lib/utils";
import { SEED_CASH_REQUESTS } from "../../_components/_data";
...
export default function CashRequisitionDetailPage({
  ...
  const record = SEED_CASH_REQUESTS.find((r) => r.id === id);
          ...
          <div className="bg-brand-card border border-brand-border rounded-2xl p-6 shadow-sm">
            ...
            {record.description && (
              <div className="mt-6 pt-5 border-t border-brand-border">
                <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-brand-text-secondary mb-2">
                  <AlignLeft size={13} />
                  Description
                </div>
