...
// // Fleet selectors (still valid, but now SUPPORTING data only)
// import {
//   getVehicles,
//   getAvailableVehicles,
// } from "@/lib/modules/fleet/selectors/vehicles.selectors";
...
//    * Orders now drive fleet activity
//    */
...
//   /**
//    * 🚚 ORDER → FLEET RELATIONSHIP MODEL
//    */
...
//     (o) => o.fulfillment_status === "assigned"
//   );
...
//   return (
//     <AppLayout pageTitle="Order Fulfillment Operations">

//       <PageHeader
//         title="Order Fulfillment Operations"
//         description="Monitor orders, track deliveries, and manage fleet execution resources"
//         action={
//           <div className="flex flex-wrap gap-2">

//             {/* 🚚 Trip creation is still valid but now tied to Orders */}
//             <Button href="/fleet/trips/new">
//               Create Trip
//             </Button>
...
//       {/* KPI SECTION — NOW ORDER DRIVEN */}
//       <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">

//         <MetricCard
//           title="Pending Fulfillment Orders"
//           value={pendingFulfillmentOrders.length}
//         />
...
//         <p className="text-sm text-brand-text-secondary mt-1">
//           Order-driven logistics execution and fleet coordination
//         </p>
...
//           <WorkspaceCard
//             title="Trips & Dispatch"
//             description="Execution layer for order delivery workflows"
//             href="/fleet/trips"
//             icon={Route}
//             stat={`${trips.length} trip(s)`}
//           />
...
//           <WorkspaceCard
//             title="Vehicles"
//             description="Manage delivery vehicles and availability"
//             href="/fleet/vehicles"
//             icon={Truck}
//             stat={`${vehicles.length} vehicle(s)`}
//           />
...
//           <WorkspaceCard
//             title="Drivers"
//             description="Manage drivers assigned to delivery trips"
//             href="/fleet/drivers"
//             icon={Users}
//             stat={`${drivers.length} driver(s)`}
//           />
...
//           <WorkspaceCard
//             title="Maintenance"
//             description="Track maintenance schedules and repairs"
//             href="/fleet/maintenance"
//             icon={Wrench}
//             stat="Coming soon"
//           />
...
//         <p className="text-sm text-brand-text-secondary mt-1">
//           Operational shortcuts for fulfillment execution
//         </p>
