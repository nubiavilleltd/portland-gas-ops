  ...
  return (
    <AppLayout pageTitle="Orders & Dispatch">
      ...
      <div className="bg-white border border-brand-border rounded-2xl p-6 max-w-lg">
        <h2 className="text-base font-semibold text-brand-text-primary mb-4">Delivery Tracking</h2>
        <div className="flex items-center gap-3 mb-4">
          <div className="p-2 rounded-lg bg-brand-purple-faint text-brand-purple"><Truck size={18} /></div>
          <div><p className="text-sm font-medium">Vehicle: LAG-492 CNG Truck</p><p className="text-xs text-brand-text-secondary">Driver: Musa Abdullahi</p></div>
          <div className="ml-auto"><ApprovalBadge status="in_progress" /></div>
        </div>
