...
export const moduleGroups: readonly ModuleGroup[] = [
  ...
  },
  {
    ...
    processes: [
      ...
      },
      {
        ...
        description: "Payment status, who has been paid, and pending approvals",
        icon: BarChart2,
        href: "/admin/finance",
        routePrefixes: ["/admin/finance"],
      },
      {
        name: "All Invoice Requests",
        description: "Every supplier invoice raised on the system",
        icon: FileText,
        href: "/admin/finance/invoices",
        routePrefixes: ["/admin/finance/invoices"],
        showOnHome: false,
      },
      {
        name: "All Cash Requisitions",
        description: "Every cash requisition raised on the system",
        icon: CreditCard,
        href: "/admin/finance/cash-requisitions",
        routePrefixes: ["/admin/finance/cash-requisitions"],
        showOnHome: false,
      },
      {
        name: "Payroll",
      ...
      },
      {
        ...
        description: "What payroll costs each department, per period",
        icon: BarChart2,
        href: "/admin/payroll/by-department",
        routePrefixes: ["/admin/payroll/by-department"],
      },
      {
        name: "HR Policies",
  ...
  },
  {
    ...
    processes: [
      ...
      {
        name: "Tax & Statutory Deductions",
        description: "PAYE bands, pension and NHF rates that payroll applies",
        icon: Receipt,
        href: "/admin/setups/tax",
        routePrefixes: ["/admin/setups/tax"],
      },
    ],
  },
];
